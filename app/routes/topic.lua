...
--local tag_model = require("app.model.tag")
...
---[[
    if  is_active == 0 then
        return res:render("error", {
            errMsg = "用户未激活，不能发布文章! 加入QQ群1：522410959 QQ群2：141991731 进行激活。 邮件组 https://groups.google.com/forum/#!forum/lua-openresty-orange"
        })
    end
--]]    
